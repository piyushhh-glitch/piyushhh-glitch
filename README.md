...
- **Machine Learning** — Supervised & Unsupervised algorithms, implemented from scratch and with Scikit-learn
...
## 🤖 ML Algorithms I've Implemented
...
**From Scratch** — Linear Regression, Logistic Regression, KNN (NumPy only)
